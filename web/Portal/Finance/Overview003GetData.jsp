        ...
        try {
            ...
            if (date != null && !(date.equals(""))) {
                ...
                if ("0".equals(sort)) {
                    ...
                    int begin_date_int = Integer.valueOf((Integer.valueOf(
                            date.substring(0, 4)) - 1) + date.substring(5, 7));
            ...
            sqlstr = "select date_id,round(TOTAL_COST/10000,2),round((OPERATING_REVENUE-TOTAL_COST)/10000,2)" +
                    " from " + tableName + " where company_id=1";
            ...
            if (intRowCount > 0) {
                ...
                while (!rs.isAfterLast()) {
                    str_return = str_return + "'" + rs.getString(1) + ":"
