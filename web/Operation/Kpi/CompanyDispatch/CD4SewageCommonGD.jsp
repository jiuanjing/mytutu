...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"
         import="java.util.Date,java.util.*,com.google.gson.Gson,java.sql.*,com.bws.dbOperation.*,com.bws.util.*" %>
<%
    //实例化数据库链接
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr = "select coalesce(v101.company_id,v102.company_id,v103.company_id) company_id, "
                    ...
                    + "where a.company_id=b.company_id and a.status=1 and b.kpi_code_num=" + kpiCodeNum + " and b.date_id=" + date2 + " and a.dept_id = " + DeptID + " and a.flag_sewage = 1 order by a.order_no"
                    + ") v101 "
                    + "full join "
                    + "( "
                    + "select a.company_id,a.brief_name," + column + " all_ly from echarts.dim_op_company a, echarts.dm_op_mr_kpi_actual b "
                    + "where a.company_id=b.company_id and a.status=1 and b.kpi_code_num=" + kpiCodeNum + " and b.date_id=" + date1 + " and a.dept_id = " + DeptID + " and a.flag_sewage = 1 order by a.order_no"
                    + ") v102 "
