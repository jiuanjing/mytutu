...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select " + column + " from echarts.dm_op_mr_kpi_actual_sum t where t.sum_id=0 and t.kpi_code_num=1003 and t.date_id = " + (year - 1);//同期水费回收率
            String sqlstr2 = "select " + column + " from echarts.dm_op_mr_kpi_actual_sum t where t.sum_id=0 and t.kpi_code_num=1003 and t.date_id = " + (year);//实际水费回收率
