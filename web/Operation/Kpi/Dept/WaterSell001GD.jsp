...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select " + column + " from echarts.dm_op_mr_kpi_actual_sum t where t.sum_id = " + DeptID + " and t.kpi_code_num=1028 and t.date_id = " + (year - 1);//同期售水量
            String sqlstr2 = "select " + column + " from echarts.dm_op_mr_kpi_actual_sum t where t.sum_id = " + DeptID + " and t.kpi_code_num=1028 and t.date_id = " + year;//实际售水量
            String sqlstr3 = "select " + column + " from echarts.dm_op_mr_kpi_budget_sum t where t.sum_id = " + DeptID + " and t.kpi_code_num=1028 and t.date_id = " + year;//计划售水量
