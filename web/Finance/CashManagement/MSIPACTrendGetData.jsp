...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select date_id,round(money_saved_in_parent/10000,2),round(money_saved_in_parent_change/10000,2)," +
                    "round(money_saved_in_parent_budget/10000,2),round(money_saved_in_parent_c_budget/10000,2) from " +
                    tableName;
