...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            if ("0".equals(types)) {
                //范围为月
                tableName = "echarts.dm_concentrated_money";
            ...
            if ("1".equals(types)) {
                //范围为季度
                tableName = "echarts.dm_concentrated_money_q";
                if (begin_date != null && !(begin_date.equals(""))) {
            ...
            if ("2".equals(types)) {
                //范围为年
                tableName = "echarts.dm_concentrated_money_y";
                if (begin_date != null && !(begin_date.equals(""))) {
                    int begin_date_int = Integer.valueOf(begin_date.substring(0, 4));
                    where += " and date_id >=" + begin_date_int;
                }
            ...
            sqlstr = "select date_id,used_rate from " + tableName;
