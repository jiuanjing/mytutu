...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select t.brief_name,round(t.PROFIT_CW/10000,2),round(t.PROFIT_CW_BUDGET/10000,2)," +
                    "round((t.PROFIT_CW/t.PROFIT_CW_BUDGET)*100,2) from (select * from " + tableName
