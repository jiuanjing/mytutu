    ...
    if (db.dbOpen()) {
        try {
            ...
            if (date != null && !(date.equals(""))) {
                if ("0".equals(types)) {
                    tableNames = "echarts.dm_profitability";
                ...
                if ("1".equals(types)) {
                    tableNames = "echarts.dm_profitability_q";
                ...
                if ("2".equals(types)) {
                    tableNames = "echarts.dm_profitability_y";
                }
            }
            sqlstr = "select date_id,round(TOTAL_COST/10000,2),TOTAL_COST_YOY from " + tableNames + " where company_id=1";
