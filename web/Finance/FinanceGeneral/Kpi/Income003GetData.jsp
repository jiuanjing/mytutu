...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select b.brief_name,round((a.operating_revenue)/10000,2) from " + tableName + " a ,echarts.dim_company_fn b"
                    + " where a.company_id = b.company_id and B.FLAG_DISPLAY = 1 and a.operating_revenue > 0 and " +
