...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            //EBITDA
            String sql1 = "select date_id,EBITDA_RATIO from " + tableName + " t where company_id=1" + where + " order by date_id";
            //EBITDA同期
            String sql2 = "select date_id,EBITDA_RATIO from " + tableName + " t where company_id=1" + where1 + " order by date_id";
