...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select t.brief_name,round(t.FINANCIAL_EXPENSE/10000,2),round(t.OPERATING_REVENUE/10000,2)," +
                    "round((t.FINANCIAL_EXPENSE/t.OPERATING_REVENUE)*100,2) from " +
