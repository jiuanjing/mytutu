...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            //年累计收入
            String sql1 = "select round(OPERATING_REVENUE_TY/10000,0) from echarts.dm_operating_growth " +
                    "where company_id=1 and date_id = " + now;
            //年累计收入上个月
            String sql2 = "select round(OPERATING_REVENUE_TY/10000,0) from echarts.dm_operating_growth " +
                    "where company_id=1 and date_id = " + pre;
            //年累计收入上上个月
            String sql3 = "select round(OPERATING_REVENUE_TY/10000,0) from echarts.dm_operating_growth " +
                    "where company_id=1 and date_id = " + pre01;
            //同期年累计收入
            String sql4 = "select round(OPERATING_REVENUE_TY/10000,0) from echarts.dm_operating_growth " +
                    "where company_id=1 and date_id = " + ly;
            //同期的上个月年累计收入
