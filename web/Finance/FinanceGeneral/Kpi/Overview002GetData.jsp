...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            int t_date = 0;
				/* 归首创净利润 */
            sqlstr = "select round(NET_PROFIT/10000,0) from echarts.dm_profitability where company_id=1";//本年
            t_sqlstr = "select round(NET_PROFIT/10000,0) from echarts.dm_profitability where company_id=1";//去年

            String where = "";
            String t_where = "";
            if (date != null && !(date.equals(""))) {
                date = date.substring(0, 4) + date.substring(5, 7);
                t_date = Integer.parseInt(date) - 100;//去年同期 201601-100=201501
