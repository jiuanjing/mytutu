...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select b.brief_name,round((a.NET_OPERATING_CASH_FLOW)/10000,2) " +
                    "from " + tableName + " a ,echarts.dim_company_fn b"
                    + " where a.company_id = b.company_id and B.FLAG_DISPLAY = 1 and a.NET_OPERATING_CASH_FLOW <>0 and a.company_id>2";
