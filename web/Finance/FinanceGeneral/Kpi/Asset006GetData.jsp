...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select equity_increase_rate,b.brief_name from " + tableName + " a," +
                    "echarts.dim_company_fn b where a.company_id = b.company_id";
            sqlstr = sqlstr + where + " and a.company_id > 2 and B.FLAG_DISPLAY = 1 and a.equity_increase_rate <> 0 and b.status=1 and b.company_level=2 order by a.equity_increase_rate desc";
