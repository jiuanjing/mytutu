...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            tableName = tableName.length() == 0 ? "echarts.dm_operating_growth" : tableName;
            sqlstr = "select date_id,round(OPERATING_REVENUE_TY/10000,2),SELLING_GROWTH_RATE from " +
                    tableName + " where company_id=1";
