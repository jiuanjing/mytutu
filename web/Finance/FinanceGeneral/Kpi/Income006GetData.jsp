...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String tableName = "echarts.dm_operating_growth";
            String where = "";
            if ("0".equals(types)) {
            ...
            sqlstr = "select t.brief_name,round(t.operating_revenue_ty/10000,2),round(t.operating_revenue_ly/10000,2),t.selling_growth_rate from (select * from " + tableName + " a,echarts.dim_company_fn b"
                    + " where a.company_id = b.company_id and B.FLAG_DISPLAY = 1 and a.company_id > 2";


            sqlstr = sqlstr + where + " and b.status=1 and b.company_level=2 order by a." + sort + " " +
                    order + ") t where rownum<=10 AND t.operating_revenue_ty > 0";
