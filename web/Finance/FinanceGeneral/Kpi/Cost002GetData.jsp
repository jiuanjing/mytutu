...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            //三项费用占收入比
            String sql1 = "select date_id,PROPORTION_OF_THREE_EXPENSE from " + tableName + " t where company_id=1" + where + " order by date_id";
            //三项费用占收入比同期
            String sql2 = "select date_id,PROPORTION_OF_THREE_EXPENSE from " + tableName + " t where company_id=1" + where1 + " order by date_id";
