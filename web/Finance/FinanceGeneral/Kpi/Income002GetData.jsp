        ...
        try {
            ...
            if ("0".equals(types)) {
                if (date != null && !(date.equals(""))) {
                    ...
                    t_where += " and date_id =" + (Integer.valueOf(date) - 100);
                } else {
                    //默认日期为上个月
            ...
            sqlstr = "select round(OPERATING_REVENUE/10000,0) from " + tableName + " where company_id=1";
            t_sqlstr = "select round(OPERATING_REVENUE/10000,0) from " + tableName + " where company_id=1";

            sqlstr = sqlstr + where;
            t_sqlstr = t_sqlstr + t_where;

            Gson gson = new Gson();
            //System.out.println(t_sqlstr);
