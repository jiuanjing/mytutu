...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select c.brief_name,round(sum(a.TOTAL_ASSET)/10000,2) from " + tableName + " a ," +
                    "echarts.dim_company_fn b,echarts.dim_dept c "
            ...
            sqlstr = sqlstr + where + " and b.status=1 and b.company_level=2 and " +
                    "c.status=1 group by c.brief_name order by sum(a.TOTAL_ASSET)";
