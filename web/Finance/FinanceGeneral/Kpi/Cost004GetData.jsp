...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select t.brief_name,round(t.MANAGEMENT_EXPENSE/10000,2),round(t.OPERATING_REVENUE/10000,2)," +
                    "round((t.MANAGEMENT_EXPENSE/t.OPERATING_REVENUE)*100,2) from " +
                    "(select * from " + tableName + " a,echarts.dim_company_fn b"
                    + " where a.company_id = b.company_id and B.FLAG_DISPLAY = 1 and a.OPERATING_REVENUE <> 0 and a.company_id > 2";
