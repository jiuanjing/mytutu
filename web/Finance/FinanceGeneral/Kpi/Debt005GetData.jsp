...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            //EBIT
            String sql1 = "select date_id,EBIT_RATIO from " + tableName + " t where company_id=1" + where + " order by date_id";
            //EBIT同期
            String sql2 = "select date_id,EBIT_RATIO from " + tableName + " t where company_id=1" + where1 + " order by date_id";
