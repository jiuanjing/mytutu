...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sort = request.getParameter("types").trim();
            ...
            if ("0".equals(sort)) {
                ...
                sqlstr = "select round(PROFIT_PARENT/10000,0) from " + tableName + " where company_id=1";
                t_sqlstr = "select round(PROFIT_PARENT/10000,0) from " + tableName + " where company_id=1";
                sqlstr = sqlstr + where;
