...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select t.brief_name,t.CCDR from (select * from " + tableName
                    + " a,echarts.dim_company_fn b"
                    + " where a.company_id = b.company_id and B.FLAG_DISPLAY = 1 and a.CCDR <> 0 and a.company_id > 2";
