...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select t.company_id,t.brief_name,t.OPE from " +
                    "(select a.COMPANY_ID,b.brief_name,a.OPE from " + tableName + " a," +
                    "echarts.dim_company_fn b"
                    + " where  a.company_id = b.company_id and a.OPE <> 0 and a.company_id > 2";
            sqlstr = sqlstr + where + "and B.FLAG_DISPLAY = 1 and b.status=1 and b.bu_id = 5 and b.company_level=2 order by a." + sort + " " + order + ") t where rownum<=10";
