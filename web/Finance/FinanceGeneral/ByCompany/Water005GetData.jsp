...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select t.company_id,t.brief_name,t.COST_PROFIT_RATIO from " +
                    "(select a.COMPANY_ID,b.brief_name,a.COST_PROFIT_RATIO from " +
                    tableName + " a,echarts.dim_company_fn b"
                    + " where a.company_id = b.company_id and B.FLAG_DISPLAY = 1 and a.COST_PROFIT_RATIO <> 0 and a.company_id > 2";
