...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select t.company_id,t.brief_name,t.PROPORTION_OF_THREE_EXPENSE from " +
                    "(select a.COMPANY_ID,b.brief_name,a.PROPORTION_OF_THREE_EXPENSE from " +
                    tableName + " a,echarts.dim_company_fn b"
                    + " where a.company_id = b.company_id and B.FLAG_DISPLAY = 1 and a.PROPORTION_OF_THREE_EXPENSE <> 0 and a.company_id > 2";
