...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select t.company_id,t.brief_name,round(t.PROFIT_CW/10000,2) from " +
                    "(select a.COMPANY_ID,b.brief_name,a.PROFIT_CW from " + tableName + " a,echarts.dim_company_fn b"
                    + " where a.company_id = b.company_id and B.FLAG_DISPLAY = 1 and a.PROFIT_CW <> 0 and a.company_id > 2";
