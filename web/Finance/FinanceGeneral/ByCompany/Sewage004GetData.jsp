...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select t.company_id,t.brief_name,t.COST_PER_UNIT,t.COST_PER_UNIT_YOY from " +
                    "(select a.COMPANY_ID,b.brief_name,a.COST_PER_UNIT,a.COST_PER_UNIT_YOY from " +
