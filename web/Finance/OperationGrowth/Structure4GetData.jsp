...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            if ("1".equals(types)) {
                tableName = "dm_operating_growth_q";
                if (date != null && !(date.equals(""))) {
            ...
            if ("2".equals(types)) {
                tableName = "dm_operating_growth_y";
                if (date != null && !(date.equals(""))) {
            ...
            sqlstr = sqlstr + where + " and B.FLAG_DISPLAY = 1 and b.status=1 and b.company_level=2 and c.status=1 and c.region_level=3 group by c.region_name";
            ResultSet rs = null;
